  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      ...
      <header className="fixed top-0 w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-100 h-20">
        <div className="container mx-auto px-4 h-full flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-[#26B89A] rounded-lg flex items-center justify-center">
              <Bug className="text-white w-6 h-6" />
            </div>
            <span className="text-2xl font-black text-[#0F172A] tracking-tighter">ANDES<span className="text-[#26B89A]">PLAGAS</span></span>
          </div>
          <div className="flex items-center gap-4">
            <a href="tel:+56942713144" className="hidden md:flex items-center gap-2 text-[#0F172A] font-bold text-lg hover:text-[#26B89A] transition-colors">
              <Phone className="w-5 h-5 text-[#E8762E]" /> +56 9 4271 3144
            </a>
            <Button className="bg-[#E8762E] hover:bg-[#EA580C] text-white font-bold px-6 py-6 rounded-xl shadow-lg shadow-orange-500/20 cursor-pointer">
              Llamar Ahora
            </Button>
          </div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8 max-w-2xl text-white">
              <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold font-display leading-[1.1] tracking-tight">
                Desinfección Profesional en Santiago con <span className="text-[#26B89A]">Atención Inmediata</span>
              </h1>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-3 text-lg font-semibold">
                    <CheckCircle2 className="text-[#26B89A] w-6 h-6 shrink-0" />
                    <span>{item}</span>
                  </div>
                ))}
              </div>
              <div className="flex flex-col sm:flex-row gap-6 pt-4">
                <Button onClick={scrollToForm} size="lg" className="bg-[#E8762E] hover:bg-[#EA580C] text-white font-black h-20 px-10 rounded-2xl text-xl shadow-2xl shadow-orange-500/30 transition-all cursor-pointer uppercase">
              ...
              <Card className="shadow-[0_20px_50px_rgba(0,0,0,0.5)] border-0 bg-white p-2 rounded-[2rem]">
                <div className="bg-[#F8FAFC] p-8 rounded-[1.5rem]">
                  <CardHeader className="px-0 pt-0 text-center">
                    ...
                    <p className="text-[#E8762E] font-bold text-lg mt-2 uppercase tracking-widest">En solo 15 Minutos</p>
                  </CardHeader>
                  <CardContent className="px-0 pb-0 pt-6">
                    <Form {...form}>
                      <form className="space-y-5">
                        ...
                        <Button className="w-full bg-[#E8762E] hover:bg-[#EA580C] text-white font-black h-16 rounded-xl shadow-xl shadow-orange-500/20 transition-all mt-4 cursor-pointer text-lg uppercase tracking-wider">
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-[#E8762E] text-2xl font-black uppercase tracking-widest">Actúa antes de que el problema crezca</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="flex gap-6 p-8 rounded-[2rem] bg-[#F8FAFC] border border-gray-100 hover:border-[#26B89A] transition-all group">
                <div className="w-14 h-14 bg-red-100 rounded-2xl flex items-center justify-center shrink-0 group-hover:bg-[#26B89A] transition-colors">
          ...
          <div className="mt-16 text-center">
            ...
            <Button onClick={scrollToForm} size="lg" className="bg-[#26B89A] hover:bg-[#165a44] text-white font-black h-18 px-12 rounded-2xl text-xl shadow-2xl shadow-[#26B89A]/20 transition-all cursor-pointer uppercase">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="bg-white/5 p-10 rounded-[2.5rem] border border-white/10 hover:bg-white/10 transition-all flex flex-col items-center">
                <div className="w-20 h-20 bg-[#26B89A] rounded-[1.5rem] flex items-center justify-center mb-8 shadow-2xl shadow-[#26B89A]/20">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 space-y-8">
              <h2 className="text-4xl md:text-5xl font-black text-[#0F172A] uppercase tracking-tighter leading-none">¿Por qué elegir <br/><span className="text-[#26B89A]">Andes Plagas?</span></h2>
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 group">
                    <div className="w-8 h-8 rounded-full bg-[#26B89A]/10 flex items-center justify-center group-hover:bg-[#26B89A] transition-colors">
                      <Zap className="text-[#26B89A] w-4 h-4 group-hover:text-white transition-colors" />
                    </div>
                    <p className="text-lg font-bold text-[#0F172A]">{item}</p>
                  </div>
                ))}
              </div>
              <p className="text-2xl font-black text-[#26B89A] uppercase tracking-widest pt-4">“Servicio seguro, rápido y efectivo.”</p>
            </div>
            <div className="lg:w-1/2">
              <div className="relative">
                <div className="absolute -inset-4 bg-[#E8762E] rounded-[3rem] blur-2xl opacity-10"></div>
                <img 
          ...
          <div className="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
            {[
              ...
              <div key={i} className="relative p-10 rounded-[2.5rem] bg-[#F8FAFC] border border-gray-100 shadow-xl shadow-gray-200/50">
                <span className="absolute -top-4 right-10 bg-[#E8762E] text-white text-xs font-black px-4 py-2 rounded-full tracking-widest uppercase">{t.tag}</span>
                <MessageSquare className="text-[#26B89A] w-12 h-12 mb-8 opacity-20" />
                <p className="text-xl font-bold text-[#0F172A] italic mb-10 leading-relaxed">"{t.text}"</p>
                <div className="font-black text-[#26B89A] text-lg uppercase tracking-tighter">{t.company}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#0F172A] text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-1/2 h-full bg-[#26B89A]/10 blur-[120px] rounded-full"></div>
        <div className="container mx-auto px-4 text-center relative z-10">
          <h2 className="text-5xl md:text-7xl font-black mb-8 uppercase tracking-tighter">Protege tu espacio <span className="text-[#E8762E]">hoy mismo</span></h2>
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-16">
            <Button onClick={scrollToForm} size="lg" className="bg-[#E8762E] hover:bg-[#EA580C] text-white font-black h-24 px-16 rounded-[2rem] text-2xl shadow-2xl shadow-orange-500/30 transition-all cursor-pointer uppercase tracking-tighter">
              Solicitar Desinfección Ahora
            </Button>
            <Button size="lg" variant="outline" className="border-2 border-[#26B89A] text-[#26B89A] hover:bg-[#26B89A] hover:text-white font-black h-24 px-16 rounded-[2rem] text-2xl transition-all cursor-pointer uppercase tracking-tighter">
              WhatsApp Directo
            </Button>
          </div>
          <div className="flex flex-col items-center gap-4">
            <p className="text-gray-500 font-black uppercase tracking-[0.3em] text-sm">Llamada de urgencia 24/7</p>
            <a href="tel:+56942713144" className="flex items-center gap-4 text-4xl md:text-6xl font-black hover:text-[#E8762E] transition-colors tracking-tighter">
              <PhoneCall className="text-[#E8762E] w-12 h-12 md:w-16 md:h-16" /> +56 9 4271 3144
            </a>
          </div>
        </div>
      </section>
      ...
      <footer className="py-12 bg-white border-t border-gray-100">
        <div className="container mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-2 mb-8">
            <Bug className="text-[#26B89A] w-8 h-8" />
            <span className="text-2xl font-black text-[#0F172A] tracking-tighter">ANDES<span className="text-[#26B89A]">PLAGAS</span></span>
          </div>
